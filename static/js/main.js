...
function change_main_hero(event, position) {
  // 현재 메인에 있는 마블 캐릭터
  let current_main_name = $("#main_hero span").text();
  ...
  console.log(currnent_main_hero, new_main_hero);

  $("#main_hero span").text(new_main_hero.hero);
  $(`#sub_hero[name="${position}"] span`).text(currnent_main_hero.hero);
  event.target.name = current_main_name;
}
